...
Deck::Deck()
{
  ...
  //Hearts Cards
  this->m_cards->push_back(new Card("Hearts", "Ace", 1));
  ...
  //Spades
  this->m_cards->push_back(new Card("Spades", "Ace", 1));
  ...
  //Diamonds
  this->m_cards->push_back(new Card("Diamonds", "Ace", 1));
  ...
  //Clubs
  this->m_cards->push_back(new Card("Clubs", "Ace", 1));
